...
public class RemoveEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/planetfood/images/user.png"))); // NOI18N
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            ArrayList <Emp> empList = EmpDao.getSingleEmpData(empId);
            
            if(empList.isEmpty() == true){
                JOptionPane.showMessageDialog(null, "Sorry! Emp not found","Error!",JOptionPane.INFORMATION_MESSAGE);
                txtEmpId.setText("");
            }
            else {
    ...
    private void btnDeleteEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteEmpActionPerformed
        try { 
            ...
            if(empId.isEmpty()) {                
                JOptionPane.showMessageDialog(null, "Please Enter Emp Id !","Error!",JOptionPane.ERROR_MESSAGE);
                return;
            }            
            String username = UserDao.checkUser(empId);
            if(username!=null){
                boolean ans = UserDao.removeCashierFromEmp(empId);                
            }
            
            boolean status = EmpDao.removeEmp(empId);
            if(status) {
                JOptionPane.showMessageDialog(null, "Emp Successfully Removed!","Success!",JOptionPane.INFORMATION_MESSAGE);
                clearAll();
                txtEmpId.setText("");
            }
            else
                JOptionPane.showMessageDialog(null, "Emp Not Removed!","Error!",JOptionPane.ERROR_MESSAGE);
        }
        catch(SQLException ex) {
            JOptionPane.showMessageDialog(null, "Error while deleting Emp!","Exception!",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
